		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GIT Project1",
									"targetURL": "#sapbtpgitgit1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpgitgit1-display": {
								"semanticObject": "sapbtpgitgit1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.git.git1",
									"url": sap.ui.require.toUrl("sap/btp/git/git1")
								}
							}
						}
					}
